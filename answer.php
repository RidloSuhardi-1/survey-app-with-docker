  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid w-75">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><small>List of answer</small></h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="card card-default">
          ...
          <div class="card-body table-responsive">
            <table class="table table-head-fixed text-nowrap">
                ...
                <tbody>
                <?php
                $query = mysqli_query($connect, "SELECT * FROM answer WHERE user_id = '".$_SESSION['id']."'");
                ...
                if (mysqli_num_rows($query) > 0) {
                  while($data = mysqli_fetch_array($query))
                  {
                    ...
                    <tr>
                        ...
                        <td><?= $data['answer'] ?>..</td>
                        <td>
                            <button onclick="location.href = './answer_view.php?id=<?= $data['id'] ?>';" class="btn btn-outline-primary"><i class="far fa-eye"></i></button>
                            <button onclick="location.href = './core/delete_answer.php?id=<?= $data['id'] ?>';" class="btn btn-outline-danger"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                      <?php
                  }
