...
<head>
  ...
  <title>IMO Quesioner | Answer Question</title>
      ...
      <div class="container-fluid w-75">
        ...
        <div class="card card-default">
          ...
          while($data = mysqli_fetch_array($query))
          {
            ?>
            <!-- text input -->
            <form action="./core/answer_save.php?id=<?= $data['id'] ?>" method="POST">
                <div class="form-group">
                    <input type="hidden" name="title" value="<?= $data['title'] ?>" class="form-control">
                    <input type="hidden" name="content" value="<?= $data['content'] ?>" class="form-control">
                    <input type="hidden" name="footnote" value="<?php if ($data['footnote'] != 'none') { echo '<small>- '.$data['footnote']. '</small>'; } ?>" class="form-control">
            ...
            ?>
                <div class="form-group">
                    ...
                    <textarea name="answer" id="" class="form-control" rows="3" placeholder="Type anything.." required></textarea>
                </div>

                <hr class="my-4">
                <button onclick="location.href = 'index.php';" type="button" class="btn btn-default"><i class="fas fa-arrow-circle-left mr-2"></i> Return to Home</button>
          ...
          <div class="card-footer">
            <span>Never enter personal data in public attachments, <a href="#">privacy & rules</a></span>
          </div>
        </div>
        <!-- /.card -->
